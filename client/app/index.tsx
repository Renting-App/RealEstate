...
const mockData: Property[] = [
  {
    ...
    image: 'https://images1.apartments.com/i2/axMk19Jx10sVyvPye0ubNaS0eyGwvrMnfbSqhgWEFeA/117/1000m-chicago-il-1000m-chicago.jpg?p=1',
  ...
  },
  {
    ...
    image: 'https://images1.apartments.com/i2/NF-GijqHdoiU0AcGdrUF7wgNZrIl_pybJMjp1XJp3dk/117/mondial-river-west-chicago-il-building-photo.jpg?p=1',
...
const HomeScreen = () => {
  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedText type="title" style={styles.pageTitle}>Find Your Dream Home</ThemedText>
      <TextInput
        id="searchInput"
